    <section id="registration" class="container">
        ...
        <div class="col-lg-6">
        <form class="center" method="post" enctype="multipart/form-data" role="form" action="<?php echo base_url();?>student/update_student">
            <fieldset class="registration-form">
                <div class="form-group">
                   <input type="text" name="first_name" placeholder="First Name" class="form-control" value="<?php echo $student_info->first_name; ?>"><span class="required"></span>
                </div>
                <div class="form-group">
                   <input type="text" name="last_name" placeholder="Last Name" class="form-control" value="<?php echo $student_info->last_name; ?>"><span class="required"></span>
                </div>
                <div class="form-group">
                    <input type="text" name="email_address" placeholder="E-mail" class="form-control" value="<?php echo $student_info->email_address; ?>"><span class="required"></span>
                </div>
                <div class="form-group">
                    <input type="password" name="password" placeholder="Password" class="form-control" value="<?php echo $student_info->password; ?>"><span class="required"></span>
                </div>
                <div class="form-group">
                    <input type="password" name="password_confirm" placeholder="Confirm Password" class="form-control" value="<?php echo $student_info->password_confirm; ?>"><span class="required"></span>
                </div>
                <div class="form-group">
                    <input type="text" name="mobile_no" placeholder="Mobile No." class="form-control" value="<?php echo $student_info->mobile_no; ?>"><span class="required"></span>
                </div>

                <div class="form-group">
                    <input type="int" id="id_no" name="id_no" placeholder="ID No." class="form-control" value="<?php echo $student_info->id_no; ?>"><span class="required"></span>
                </div>

                <div class="form-group">
                    <input type="int" id="reg_no" name="reg_no" placeholder="Registration No." class="form-control" value="<?php echo $student_info->reg_no; ?>"><span class="required"></span>
                </div>
    </fieldset>
        </div>
    ...
    <fieldset class="registration-form">
                    ...
                    <div class="form-group">
                        <input type="int" id="session" name="session" placeholder="Session (ex: 2012-13)" class="form-control" value="<?php echo $student_info->session; ?>"><span class="required"></span>
                    </div>
