    <section id="registration" class="container">
        ...
        <div class="col-lg-6">
        <form class="center" method="post" enctype="multipart/form-data" role="form" action="<?php echo base_url();?>teacher/update_teacher">
            <fieldset class="registration-form">
                <div class="form-group">
                   <input type="text" name="first_name" placeholder="First Name" class="form-control" value="<?php echo $teacher_info->first_name; ?>"><span class="required"></span>
                </div>
                <div class="form-group">
                   <input type="text" name="last_name" placeholder="Last Name" class="form-control" value="<?php echo $teacher_info->last_name; ?>"><span class="required"></span>
                </div>
                <div class="form-group">
                    <input type="text" name="email_address" placeholder="E-mail" class="form-control" value="<?php echo $teacher_info->email_address; ?>"><span class="required"></span>
                </div>
                <div class="form-group">
                    <input type="password" name="password" placeholder="Password" class="form-control" value="<?php echo $teacher_info->password; ?>"><span class="required"></span>
                </div>
                <div class="form-group">
                    <input type="password" name="password_confirm" placeholder="Confirm Password" class="form-control" value="<?php echo $teacher_info->password_confirm; ?>"><span class="required"></span>
                </div>
                <div class="form-group">
                    <input type="text" name="mobile_no" placeholder="Mobile No." class="form-control" value="<?php echo $teacher_info->mobile_no; ?>"><span class="required"></span>
                </div>
