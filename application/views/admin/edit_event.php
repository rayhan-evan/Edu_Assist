    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form role="form" action="<?php echo base_url() ?>super_admin/update_event" method="post" class="form-horizontal form-groups-bordered">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="field-1" name="event_title" placeholder="Event Title" value="<?php echo $event_info->event_title; ?>" size="100">
                        </div>
                    </div>
										...
										<div class="form-group">
												...
												<div class="col-sm-5">
														<input type="text" class="form-control" id="field-1" name="event_place" placeholder="Place" value="<?php echo $event_info->event_place; ?>" size="100">
												</div>
										</div>
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="field-1" name="event_time" placeholder="10 am" value="<?php echo $event_info->event_time; ?>" size="100">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea  name="event_description" id="ck_editor"><?php echo $event_info->event_description; ?></textarea><?php echo display_ckeditor($editor['ckeditor']) ?>
                        </div>
                    </div>
