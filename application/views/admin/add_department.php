    ...
    <div class="col-md-12">                        
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form role="form" method="post" action="<?php echo base_url();?>super_admin/save_department.cfm" class="form-horizontal form-groups-bordered">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="field-1" name="department_name" placeholder="" size="100">
                        </div>
                    </div>

                    <div class="form-group">
                        
                        <label class="col-sm-3 control-label">Select Faculty</label>

                        <div class="col-sm-5">
                            <select name="faculty_id" class="form-control" style="width: 250px;">
