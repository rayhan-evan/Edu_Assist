            ...
            <div class="panel-heading">
                ...
                <div class="panel-options">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form">
                            <form role="form" method="post" action="<?php echo base_url();?>super_admin/save_faculty.cfm" class="form-horizontal form-groups-bordered">
                ...
                <label for="field-1" class="col-sm-3 control-label">Faculty Name</label>

                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="field-1" name="faculty_name" placeholder="" size="100">
                        </div>
            </div>
