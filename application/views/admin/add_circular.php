    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form role="form" method="post" action="<?php echo base_url();?>super_admin/save_circular" class="form-horizontal form-groups-bordered">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="field-1" name="circular_title" placeholder="Circular Title" size="100">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea  name="circular_description" id="ck_editor"></textarea><?php echo display_ckeditor($editor['ckeditor']) ?>
                        </div>
                    </div>
              ...
              <!--      <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Circular Publication Status</label>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5">
                            <button type="submit" class="btn btn-success">Publish Circular</button>
