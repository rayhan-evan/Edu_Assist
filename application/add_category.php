    ...
    <div class="col-md-12">                        
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form action="<?php echo base_url(); ?>super_admin/save_category" method="post" role="form" class="form-horizontal form-groups-bordered">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="category_name" id="field-1" placeholder="Category Name">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <textarea class="form-control autogrow" name="category_description" id="field-ta" placeholder="Category Description"></textarea>
                        </div>
                    </div>
